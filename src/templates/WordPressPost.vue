...
export default {
  ...
  mounted() {
    ...
    const tl = new TimelineLite();
        ...
        tl.to('.inin', 1, {delay: .2, clipPath: 'polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)', easing: 'elastic'})
        .to('.in', 1, {delay: 1.4,  clipPath: 'polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)', easing: 'easeOutQuint'}, '-=.5')
